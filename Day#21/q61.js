...
(function (Myfavorites) {
    Myfavorites[Myfavorites["Chocolate"] = 0] = "Chocolate";
    Myfavorites[Myfavorites["Perfumes"] = 1] = "Perfumes";
    Myfavorites[Myfavorites["Flowers"] = 2] = "Flowers";
})(Myfavorites || (Myfavorites = {}));
// Showing one type of vehicle from the list
console.log(Myfavorites.Perfumes); // It shows 0 because enums start counting from 0
